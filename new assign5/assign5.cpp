...
Function:   Main, This assignment is an exercise in implementing the
stack ADT using a dynamically-allocated array, as well as techniques
for managing dynamically-allocated storage in C++..
*********************************************************/
